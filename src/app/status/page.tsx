...
import type { AdSettings, AIProfile } from '@/types';
import { defaultAIProfile } from '@/config/ai';
// NOTE: tryShowRotatedAd is imported directly from the chat page. This should be refactored
// to centralize ad triggering logic in a dedicated service or context to decouple components.
